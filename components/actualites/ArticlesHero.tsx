  ...
  return (
    <section className="relative pt-32 pb-16 overflow-hidden bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <span
            className={`inline-block px-4 py-2 rounded-full text-sm font-semibold text-white bg-primary-600/80
             `}
          >
            {category?.label}
          </span>
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-600/80 mb-6 leading-tight"
        >
          {article.title}
        </motion.h1>
        ...
        <motion.div
          ...
          className="relative  overflow-hidden shadow-lg  bg-gray-100"
        >
          {article.image && (
            <Image
              src={article.image}
