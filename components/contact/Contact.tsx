  ...
  return (
    <section className="relative min-h-screen py-20 overflow-hidden bg-gradient-to-br from-primary-blue/10 via-white to-primary-green/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-trust/20 mb-6"
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            {/* Devenir Membre Card */}
            <motion.div
              className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-trust/10"
              whileHover={{ scale: 1.02, translateY: -5 }}
              transition={{ duration: 0.3 }}
            >
              <div className="w-12 h-12 bg-gradient-to-br from-trust to-trust/80 rounded-xl flex items-center justify-center mb-4">
              ...
              <div className="flex items-center gap-2 text-trust font-medium">
            ...
            {/* Devenir Mentor Card */}
            <motion.div
              className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-future/10"
              whileHover={{ scale: 1.02, translateY: -5 }}
              transition={{ duration: 0.3 }}
            >
              <div className="w-12 h-12 bg-gradient-to-br from-future to-future/80 rounded-xl flex items-center justify-center mb-4">
              ...
              <div className="flex items-center gap-2 text-future font-medium">
                <Mail className="w-4 h-4" />
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <Phone className="w-5 h-5 text-trust mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-future mt-0.5" />
                  <div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-trust focus:ring-2 focus:ring-trust/20 outline-none transition-all"
                      placeholder="Ton nom"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-trust focus:ring-2 focus:ring-trust/20 outline-none transition-all bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-trust focus:ring-2 focus:ring-trust/20 outline-none transition-all resize-none"
                ...
                <motion.button
                  ...
                  className={`w-full px-8 py-4 rounded-full font-semibold shadow-lg transition-all flex items-center justify-center gap-2 ${
                    submitStatus === 'success'
                      ...
                      : 'bg-trust text-white hover:shadow-xl glow-blue'
                  }`}
              ...
              {submitStatus === 'success' && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="mt-4 p-4 bg-future/10 border border-future/20 rounded-xl"
                >
                  <p className="text-future font-medium text-center">
