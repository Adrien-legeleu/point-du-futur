        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {workshops.map((workshop, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-12 h-12 bg-gradient-to-br from-primary-green/20 to-primary-green/10 rounded-xl flex items-center justify-center mb-4">
                    ...
                    <span className="inline-block px-2 py-1 bg-primary-green/10 text-primary-green rounded-full text-xs font-medium">
                      {workshop.frequency}
                    </span>
                  </motion.div>
                );
            ...
            <motion.div
              ...
              className="mt-8 bg-gradient-to-br from-primary-green/10 to-primary-green/5 rounded-2xl p-6 border border-primary-green/20"
            >
              <div className="flex items-start gap-3 mb-4">
                <Sparkles className="w-5 h-5 text-primary-green flex-shrink-0 mt-1" />
                <p className="text-gray-700 italic leading-relaxed">
                  "{testimonial.text}"
                </p>
              </div>
              <div className="flex items-center gap-3 ml-8">
                <div className="w-10 h-10 rounded-full bg-primary-green/20 flex items-center justify-center text-xl">
                  {testimonial.avatar}
                </div>
                <div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-green/10 text-primary-green font-medium mb-6">
              <Compass className="w-4 h-4" />
              Trouve ta voie
            </div>

            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              Ateliers d'<span className="text-primary-green">Orientation</span>
            </h2>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-primary-green/10 text-primary-green rounded-full text-sm font-medium">
                    Ateliers mensuels
                  </span>
                  <span className="px-4 py-2 bg-primary-green/10 text-primary-green rounded-full text-sm font-medium">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-8 py-4 bg-primary-green text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all"
            >
