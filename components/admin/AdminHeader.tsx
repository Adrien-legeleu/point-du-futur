        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {user?.user_metadata?.avatar_url ? (
              ...
              <div className="w-10 h-10 bg-gradient-to-br from-trust to-future rounded-full flex items-center justify-center text-white font-bold">
          ...
          <button className="relative w-10 h-10 rounded-xl bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
            ...
            {notifications > 0 && (
              <span className="absolute -top-1 -right-1 w-5 h-5 bg-trust text-white text-xs font-bold rounded-full flex items-center justify-center">
                {notifications}
              </span>
            )}
          </button>
